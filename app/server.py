    ...
    class APIRequestHandler(http.server.SimpleHTTPRequestHandler):
            ...
            if clean_path == '/api/session-state':
                ...
                try:
                    ...
                    if 'gemini_api_key' in data:
                        ...
                        if posted_key and len(posted_key) >= 20:
                            # Acceptem qualsevol clau suficientment llarga
                            ...
                            print(f"[Config] Clau API massa curta ignorada: longitud={len(posted_key)}")
                        # Si esta buida, no toquem res
        ...
        def do_GET(self):
            ...
            if clean_path == '/api/session-state':
                ...
                if env_key and not env_key.startswith("AIzaSy"):
                    env_key = ""
                sess_key = sess.get("gemini_api_key", "")
                if sess_key and not sess_key.startswith("AIzaSy"):
                    sess_key = ""
