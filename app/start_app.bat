...
:: Comprovar si rapidocr-onnxruntime està instal·lat i si no, instal·lar-lo
python -c "import rapidocr_onnxruntime" 2>nul
if %errorlevel% neq 0 (
    echo S'està instal·lant la llibreria rapidocr-onnxruntime per al processament local d'OCR...
